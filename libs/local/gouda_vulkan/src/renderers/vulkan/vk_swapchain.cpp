...
// Implementation -------------------------------------------------------------------------------------
VulkanSwapchain::VulkanSwapchain(GLFWwindow *window, VulkanDevice *device, VulkanInstance *instance,
                                 BufferManager *buffer_manager, VSyncMode vsync_mode)
...
void VulkanSwapchain::UpdateExtent()
{
    int width{0};
    int height{0};
