...
void UIManager::Render(const f32 delta_time, gouda::vk::Renderer &renderer, std::vector<gouda::InstanceData>& quad_instances, std::vector<gouda::TextData>& text_instances)
{
    //for (const auto &element : m_elements) {
        //element->Render()
    //}
